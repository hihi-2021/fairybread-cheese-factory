...
//    const found = cheeseData.find(cheese => cheese.id === cheeseInfo.id);
//    found.votes = newVoteValue
...
//When button "Vote" is clicked then the vote attribute on the cheese object should increment by 1
